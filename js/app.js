(() => {
    ...
    (() => {
        ...
        const rangeBlock = document.querySelector(".range-price");
        if (rangeBlock) {
            const rangeInputs = rangeBlock.querySelectorAll(".range-price__input");
        ...
        function filterClearShow(targetElement) {
            ...
            const rangeInputs = filterBlock.querySelectorAll(".range-price__input");
            setTimeout((() => {
                ...
                if (rangeBlock) for (let index = 0; index < rangeInputs.length; index++) {
                    const rangeInput = rangeInputs[index];
                    if (rangeInput.value) filterClear.classList.add("_active"); else if (filterClear.classList.contains("_active")) return; else filterClear.classList.remove("_active");
                }
            }), 0);
        }
